...
var Reveal = (function(){
	...
	function slide( h, v, f, o ) {
		if (actions[currentSlideIndex][1] != null) setTimeout(actions[currentSlideIndex][1],100);
		// Remember where we were at before
		previousSlide = currentSlide;
		
		
		currentSlideIndex=h;
		$(".inner_menu a").attr('class',"");$(".inner_menu a").eq(currentSlideIndex).attr("class",'highlight');
		if (actions[currentSlideIndex][0] != null) setTimeout(actions[currentSlideIndex][0],200);
